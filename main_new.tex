...
\begin{sidewaysfigure}
    ...
    \begin{tikzpicture}[
        ...
        \node[smallbox] (cont_g2_i_par)  at (\xG+3.4,\yCont+7.6) {Parametric\\(e.g., normality)};
        \node[smallbox] (cont_g2_i_npar) at (\xG+3.4,\yCont+6.0) {Non-parametric};
        \node[smallbox] (cont_g2_p_par)  at (\xG+3.4,\yCont+4.4) {Parametric\\(e.g., normality)};
        \node[smallbox] (cont_g2_p_npar) at (\xG+3.4,\yCont+2.8) {Non-parametric};
        \node[smallbox] (cont_gk_i_par)  at (\xG+3.4,\yCont+1.3) {Parametric\\(e.g., normality)};
        \node[smallbox] (cont_gk_i_npar) at (\xG+3.4,\yCont-0.3) {Non-parametric};
        \node[smallbox] (cont_gk_p_par)  at (\xG+3.4,\yCont-1.9) {Parametric\\(e.g., normality)};
        \node[smallbox] (cont_gk_p_npar) at (\xG+3.4,\yCont-3.5) {Non-parametric};
        ...
        % Continuous tests
        \node[box] (t_ind_t)     at (\xG+7.3,\yCont+7.6) {Student's t-test};
        \node[box] (mw_ind_t)    at (\xG+7.3,\yCont+6.0) {Mann--Whitney U};
        \node[box] (t_pair_t)    at (\xG+7.3,\yCont+4.4) {Paired t-test};
        \node[box] (w_pair_t)    at (\xG+7.3,\yCont+2.8) {Wilcoxon\\signed-rank};
        \node[box] (anova_t)     at (\xG+7.3,\yCont+1.3) {ANOVA};
        \node[box] (kw_t)        at (\xG+7.3,\yCont-0.3) {Kruskal--Wallis};
        \node[box] (rm_anova_t)  at (\xG+7.3,\yCont-1.9) {Repeated-measures\\ANOVA};
        \node[box] (fried_t)     at (\xG+7.3,\yCont-3.5) {Friedman};
