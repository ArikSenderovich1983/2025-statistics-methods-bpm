...
% Full-page landscape figures (used for the decision tree PDF).
\usepackage{rotating}
...
\begin{sidewaysfigure}
    \centering
    \includegraphics[width=\textheight]{images/decision-tree.pdf}
    \caption{Decision tree (left-to-right) to guide the selection of a statistical test.}
