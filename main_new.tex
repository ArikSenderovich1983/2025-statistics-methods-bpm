...
\begin{svgraybox}
\blocking
    \textbf{Blocking} is a design choice where observations are grouped into ``blocks'' that are similar with respect to a nuisance factor, so that comparisons are made \emph{within} blocks rather than across heterogeneous subjects or cases.
    \begin{itemize}
